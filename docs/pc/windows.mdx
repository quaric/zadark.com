...
<Image src={require('./img/windows-protected-your-pc.png').default} alt="windows-protected-your-pc" isRounded />
...
Cách khắc phục lỗi: Chọn **Run anyway** để cài đặt ZaDark.

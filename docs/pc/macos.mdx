...
<Image
  src={require('./img/macos-zsh-terminated-zadark.jpeg').default}
  alt="macos-zsh-terminated-zadark"
  isRounded
/>
...
- B1. Cài đặt lại Zalo PC [**tại đây**](https://zalo.me/pc) (<strong style={{ color: 'red' }}>KHÔNG GỠ ZALO PC</strong> vì dữ liệu có thể bị mất)
- B2. Chạy lại ZaDark: Mở **Finder** > **Applications** > **ZaDark** hoặc [**Xem hướng dẫn**](#install-zadark)
